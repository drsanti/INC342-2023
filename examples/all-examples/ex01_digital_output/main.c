...
int main(void)
{
	...
	/**
	 * Ex1.
	 * Access the digital output channel specified by the function name.
	 */
	...
	/**
	 * Ex2.
	 * Access the digital output channel specified by the ID.
	 */
	...
	/**
	 * Ex3.
	 * Control output logic specified by function name and value.
	 */
	...
	/**
	 * Ex4.
	 * Control output logic specified by ID and value.
	 */
	...
	/**
	 * Ex5.
	 * Control output logic specified by a byte data.
