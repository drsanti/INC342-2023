/************************************************************
 * Example 48. Local File (HTML, CSS, JavaScript) Server    *
 ************************************************************
 * File:    main.c                                          *
    ...
    switch( get_state()  ) {
        ...
        case SERVER_STATE_RESPONSE:
             ...
             */
                ...
                Esp_AtSendData( TargetHttpHead, strlen(TargetHttpHead), AT_DEFAULT_TIMEOUT );
                server.respState++;                 /* Changed to iRESP_HEAD_TARGET             */
                SUSPEND( 1 );   /* Move to the next state, waiting is not required in this state */
            }
            /**
             ...
             */
                ...
                Esp_AtSendData( TargetRespHead, strlen(TargetRespHead), AT_DEFAULT_TIMEOUT );
             ...
             */
                 ...
                 */
                Esp_AtSendData( chunk.PtrFrame, chunk.SendBytes, AT_DEFAULT_TIMEOUT );
                ...
                SUSPEND( 1000 );                            /* The SUSPEND() will be terminated when a response is received */
            }
